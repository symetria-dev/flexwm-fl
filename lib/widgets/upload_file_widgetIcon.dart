...
class UploadFileIcon extends StatefulWidget {
  ...
  @override
  State<UploadFileIcon> createState() => uploadFileIcon();
}

// ignore: camel_case_types
class uploadFileIcon extends State<UploadFileIcon> {
  String? _ruta;
